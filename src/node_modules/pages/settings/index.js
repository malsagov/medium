                        ...
                        <form onSubmit={handleSubmit}>
                            <fieldset>
                                <fieldset className='form-group'>
                                    <input className='form-control form-control-lg' type='text' placeholder='URL of profile picture' value={image || ''} onChange={e => setImage(e.target.value)}/>
                                </fieldset>
                                <fieldset className='form-group'>
                                ...
                                <fieldset className='form-group'>
                                    <textarea className='form-control form-control-lg' rows='8' type='text' placeholder='Short bio' value={bio || ''} onChange={e => setBio(e.target.value)}></textarea>
                                </fieldset>
                                <fieldset className='form-group'>
                                ...
                                <button type='submit' className='btn btn-primary btn-lg pull-xs-right'>Update settings</button>
                            </fieldset>
                        </form>
                        <hr/>
