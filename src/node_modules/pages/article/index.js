            ...
            <div className='banner'>
                {!fetchArticleIsLoading && fetchArticleResponse && (
                    <div className='container'>
                        <h2>{fetchArticleResponse.article.title}</h2>
                        <div className='article-meta'>
                            <NavLink to={`/profile/${fetchArticleResponse.article.author.username}`}>
                            ...
                            {isAuthor() && (
                                <span>
                                    <NavLink className='btn btn-outline-secondary btn-sm' to={`/articles/${fetchArticleResponse.article.slug}/edit`}>
